        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/pakaian') ?>" class="side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('categories/sepatu') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Sepatu </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/bola') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Bola </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?= base_url('categories/alat') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Alat </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('categories/tas') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Tas </div>
                        </a>
                    </li>
