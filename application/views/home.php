<div class="content">
    <h2 class="intro text-lg font-medium mt-10">
        Product List
    </h2>
            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                <div class="box">
                    ...
                    <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <a class="flex items-center btn btn-sm btn-primary mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="shopping-cart" class="w-4 h-4 mr-1"></i> Masukkan Keranjang </a>
        ...
        <!-- <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                <ul class="pagination">
                    ...
                    <li class="page-item">
                        <a class="page-link" href="#"> <i clazss="w-4 h-4" data-lucide="chevrons-right"></i> </a>
                    </li>
                </ul>
            </nav>
