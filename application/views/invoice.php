...
<head>
    ...
    <!-- Tambahkan link CSS eksternal jika diperlukan -->
    <style>
    @media print {
        body * {
            visibility: hidden;
    ...
    <div class="content">
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                ...
                <button onclick="window.print()" class="btn btn-default shadow-md">Print Invoice</button>
            </div>
        </div>
        <!-- BEGIN: Invoice -->
        <div id="invoicePrintArea" class="intro-y box overflow-hidden mt-5">
            <!-- Invoice content you want to print starts here -->
            <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
                ...
                <!-- Client and Payment From details -->
                <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                    ...
                    <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                        ...
                        <div class="text-lg font-medium text-primary mt-2">Sport Center Commerce</div>
                        <div class="mt-1">info.Sport Center@mail.co.id</div>
                    </div>
                </div>
            </div>
            <!-- Table of products -->
